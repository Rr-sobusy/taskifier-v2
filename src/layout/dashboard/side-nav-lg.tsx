...
const SidenavLg = ({ routes = [ ], activePath = "/tasks" }: { routes?: SidenavType[], activePath?: SidenavType["href"] }) => {
    return (
            ...
            <div className="flex flex-col mt-7 gap-3 justify-center items-center">
                {
                    routes.map((route) => {
                        ...
                        return <Link className={`w-10 h-10  flex justify-center items-center rounded-xl`} key={route.title} href={route.href}>
